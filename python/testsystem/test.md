Here's a Python script that, when run, will create all the necessary files for your FastAPI test system project, including the database setup, models, schemas, CRUD operations, main app, static HTML interface, and a `requirements.txt` file.
...
1. Save the above script as `setup_test_system.py` (or any name you like).
2. Run it with Python: `python setup_test_system.py`
3. It will create all the project files and folders in the current directory.
4. Install dependencies: `pip install -r requirements.txt`
5. Run the FastAPI app: `python main.py`
6. Open the `static/index.html` file in a browser to use the simple interface (or serve it with a static file server).

---

If you want, I can help you with instructions on serving the static files via FastAPI or adding more features. Just ask!