...
int main() {
    ...
    for ( int i = 0 ; i <16 ; ++i)
    {
        std::cout << "\nFormat to Buffer test # " << i << "\n";
        saTotal += stringstream_any_example();
        ssTotal += stringstream_example();
        spTotal += spdlog_example();
    }
    std::cout << "\n\nFormat to Buffer results " << "\n";
    std::cout << "Spdlog Time:                  " << spTotal*1000.0/16.0 << " mS\n";
    std::cout << "String Stream Time:           " << ssTotal*1000.0/16.0 << " mS\n";
    std::cout << "String Stream using Any Time: " << saTotal*1000.0/16.0 << " mS\n";
