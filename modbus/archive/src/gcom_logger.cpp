...
namespace Logging
{
    ...
    void Init(std::string module, int argc, const char** argv)
    {
...
{
    Logging::Init(module, argc, argv);
    FPS_INFO_LOG("Logger Test: Entering main loop.");
    FPS_LOG_IT("startup");
    return 0;
}
