...
struct IO_Work_Q {
    ...
    //rigtorp::MPMCQueue<IO_Work>  io_set_q{1024};        // highest priority (must be empty before going to poll_q)
    //rigtorp::MPMCQueue<IO_Work>  io_get_q{1024};        // highest priority (must be empty before going to poll_q)
};
...
struct Main_Work_Q {
    ...
    //rigtorp::MPMCQueue<IO_Work>  io_ret_q{1024};        // highest priority (must be empty before going to poll_q)
};
...
struct Msg_Staging_Area
{
    ...
    static std::size_t get_bytes_needed(const config_loader::Component& component)
    {
        ...
        // needed += sizeof(Set_Chan_Msg) * component.registers.size() + alignof(Set_Chan_Msg);
