...
namespace Logging
{
    ...
    extern void log_msg(spdlog::level::level_enum severity, std::tuple<std::string,std::string,std::string> pre, std::string msg_stripped, std::string original_msg, std::string post);
    ...
    extern std::tuple<std::string,std::string,std::string> pre_string(const char * file, const char* func, const int line); 
