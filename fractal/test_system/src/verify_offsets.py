...
[rtos:input:0]
 ...
 rack_voltage:1
  ...
  dataff:41:7
  post_temp_max:48
  post_temp_max_mod:49
  post_temp_max_mod_num:50
  post_temp_min:51
  post_temp_min_mod:52
  post_temp_min_mod_num:53
  post_temp_avg:54
  max_module_volt:55
  max_module_volt_num:56
  max_module_volt:57
  max_module_volt_num:58
 total_charge_cap:59:2
 total_discharge_cap:61:2
 single_charge_cap:63
 single_discharge_cap:64
 charge_num:65
 discharge_num:66
 volt2:67
 volt2:68
 ...
 curr3:70
 heartbeat:71
 ins_collect_status:72
 charge_discharge_status:73
 battery_error_code:74
 battery_relieve_cond:75
 battery_relieve_time:76
 total_fault_num:77
 fault_num:78
 fault_data:79:18
 dummy:97:33
 remaining_capacity:130
 limit_temp_work_time:131
 limit_temp_chg_time:132
 deep_discharge_num:133
 single_discharge_cap:134:2
 single_charge_cap:136:2
 discharge_cap:138:2
 charge_cap:140:2
 discharge_energy:142:2
 charge_energy:144:2
 remaining_charge_power:146:1
 remaining_charge_power_100:147:1
remining_round_trip_eff:148:1
 remaining_power_capability:149:1
 chargeable_current:150
 dischargeable_current:151
 chargeable_power:152
 dischargeable_power:153
 volt_max_num:154
 volt_min_num:155
 temp_max_num:156
 temp_min_num:157
 ...
 soh_min_num:161
 allffff:162:2
 daily_charge_cap:164:2
 daily_discharge_cap:166:2
 charge_temp_1:168
 charge_temp_2:169
 charge_temp_3:170
 charge_temp_4:171
